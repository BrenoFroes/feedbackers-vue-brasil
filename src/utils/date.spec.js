...
describe('Format date', () => {
  ...
  it.skip('should return format date when input is a validate date with different month', () => {
    expect(getDiffTimeBetweenCurrentDate('Tue May 28 2022 19:44:51 GMT-0300 (Hora padrão de Brasília)')).toBe('33 dias atrás')
  })
  it.skip('should return format date when input is a validate date with same month but yesterday', () => {
    expect(getDiffTimeBetweenCurrentDate('Tue Jun 27 2022 19:44:51 GMT-0300 (Hora padrão de Brasília)')).toBe('1 dia atrás')
  })
  it.skip('should return formate date when input is a validate date with same month but one hour ago', () => {
    expect(getDiffTimeBetweenCurrentDate('Tue Jun 28 2022 18:44:51 GMT-0300 (Hora padrão de Brasília)')).toBe('1 hora atrás')
  })
  it.skip('should return formate date when input is a validate date with same month but minutos ago', () => {
    expect(getDiffTimeBetweenCurrentDate('Tue Jun 28 2022 19:34:51 GMT-0300 (Hora padrão de Brasília)')).toBe('20 minutos atrás')
  })
  it.skip('should return formate date when input is a validate date with same month but seconds ago', () => {
